...
ActiveRecord::Schema.define(version: 20170721135739) do
  ...
  create_table "deviseusers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "deviseusers_roles", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "deviseuser_id", null: false
